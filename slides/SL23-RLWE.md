...
- 多項式$s(x)=s_0+s_1x+\dots+s_{n-1}x^{n-1}\quad s_i \in \{0,1\}$を秘密鍵として出力する

<p style="font-size: 1.4rem;"><MathInline expr="\text{Enc}(\Delta\mu(x),s(x))\to (a(x),b(x)=a(x)s(x)+\Delta\mu(x)+e(x)\text{ mod } x^n+1)"/>:</p>
