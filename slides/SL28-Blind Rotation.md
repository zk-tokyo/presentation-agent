...
<h2>暗号文での計算</h2>
<p>
<MathInline expr="\hat{\mathbf{a}}\gets\left\lfloor \mathbf{a}\frac{2n}{q}\right\rceil"/> （暗号文の大きさを多項式の次数の大きさに合わせる処理） <br>
<MathInline expr="\hat{b}\gets \left\lfloor b\frac{2n}{q}\right\rceil"/> （同上）<br>
