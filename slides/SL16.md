...
<span class="text-amber-600 font-black mr-1">&#9654;</span>要点：証明者は native 実行の <strong>10<sup>3</sup>&#8211;10<sup>6</sup> 倍</strong>重いのが課題。continuations / precompiles / recursion / GPU proving で実用化が進む。検証側は一貫して軽い。
</div>
