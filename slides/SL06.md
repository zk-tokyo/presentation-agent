...
<ul>
	<li>2009年にGentryによって格子を用いることで初めて実現されたFHE</li>
	 <li>この方式ではBootstrappingと呼ばれる操作を導入することによりFHEを実現したが、当初の方式は計算量が非常に大きく、実用には遠かった。</li>
</ul>
</div>
...
<ul>
	<li>浮動小数点などの近似値計算を準同型演算することができるFHE</li>
