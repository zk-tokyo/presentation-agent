...
<p class="text-center" style="font-size: 1.2rem;">値の組み<MathInline expr="(\mathbf{a}, b)"/>が<MathInline expr="\mathbf{as} +e \equiv b \text{ (mod } q)"/>を満たすか、<br>ただのランダムな値の組み合わせなのか判定する問題</p>
</div>
