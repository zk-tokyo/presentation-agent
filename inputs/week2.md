...
構成: 120分講義 + 30分休憩 + 3時間ホワイトボードセッション  
形式: オンサイト、20-25名想定
...
| 36 | Part 6 | 応用を見るための型 |
| 37 | Part 6 | Threshold signature / MPC wallet |
| 38 | Part 6 | Private Set Intersection |
| 39 | Part 6 | Privacy-preserving analytics |
| 40 | Part 6 | Matching / auction / voting |
